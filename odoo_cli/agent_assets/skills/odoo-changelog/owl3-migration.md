<!--
Bundled copy of the upstream OWL 3 migration guide, for offline reference from
the odoo-changelog skill (OWL 3 ships with Odoo 20.0 / master).

Source (authoritative, may be newer — this is a DRAFT/WIP upstream):
https://odoo.github.io/owl/documentation/v3/owl/migration_owl2_to_owl3.html
Raw: https://raw.githubusercontent.com/odoo/owl/master/doc/v3/owl/migration_owl2_to_owl3.md

Copied verbatim. When in doubt, check the upstream link — it is a draft and the
OWL/Odoo code is the final word.
-->
